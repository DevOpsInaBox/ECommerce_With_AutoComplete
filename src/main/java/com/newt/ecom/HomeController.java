...
public class HomeController {
    ...
    @RequestMapping(value = "/getTagsProduct", method = RequestMethod.GET)
    public @ResponseBody
    List<Product> getTags(@RequestParam String tagName) {
        return simulateSearchResult(tagName);
    }

    private List<Product> simulateSearchResult(String tagName) {

        List<Product> result = new ArrayList<Product>();
        RestTemplate restTemplate = new RestTemplate();
        result = restTemplate.getForObject("http://localhost:9200/findByProductName/" + tagName, List.class);
//        System.out.println("result-->" + result);
    ...
    public @ResponseBody
    List<Product> getTagsProduct(@RequestParam String productName) {
