...
<!--<script src="resources/ajax/js/jquery-ui-1.12.1/jquery-ui.js"></script>-->
 ...
 <table id="searchProduct">
		<tr>
		<td><input type="text" class="searchtext" style="margin-left:700px;margin-top:10px" placeholder="Search Products" id="w-input-search" name="search">
               ...
               <c:if test="${empty loggedInProfile.username }">
                   ...
                   <table >
                    <tr>
                     ...
                     <tr>
                     <!--<td><a href="./getTagsProduct">Click the link to register-shyam changes</a></td>-->
...
//			serviceUrl: 'http://localhost:8080/ECommerce/getTagsProduct?tagName=hi',
			serviceUrl: '${pageContext.request.contextPath}/getTagsProduct',
			paramName: "tagName",
			delimiter: ",",
